...
title: "팔로알토네트웍스, 실적 서프라이즈에도 이틀간 13% 급락 vs 델 16% 폭등 - 같은 주 '어닝 비트'가 갈린 이유"
description: "팔로알토네트웍스는 매출 34% 증가·가이던스 상향에도 마진 우려로 이틀간 13% 급락했지만, 델은 비슷한 실적 서프라이즈로 하루 만에 16% 폭등했습니다. 같은 주 두 '어닝 비트'가 정반대로 갈린 배경을 분석합니다."
...
관련 글: [델 주가, 실적 발표 전날 6% 급락했다가 하루 만에 16% 폭등](/news/dell-earnings-reversal-95-billion-ai-backlog-stock-surge-13-percent/), [9월 첫째 주 증시 관전 포인트: 델·팔로알토네트웍스·브로드컴 실적 사흘 연속 발표](/news/week-ahead-dell-broadcom-palo-alto-jobs-report-september-1-4/)
