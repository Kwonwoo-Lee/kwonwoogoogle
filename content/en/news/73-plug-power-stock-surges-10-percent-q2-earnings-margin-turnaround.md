...
title: "Plug Power (PLUG) Stock Jumps 10% - Q2 Revenue of $178.3M Beats Estimates as Gross Margin Swings From -30% to Near Breakeven, 2026 Guidance Raised"
...
The 58% quarter-over-quarter drop in cash usage may matter even more from a financial-health standpoint. For chronically unprofitable growth companies, the single biggest overhang on the stock is often not the loss itself but the fear that cash will eventually run low enough to force another dilutive equity raise. A visibly slowing cash-burn rate directly reduces that dilution risk, and Wall Street responded accordingly: Susquehanna lifted its price target from $2.75 to $3.75, Canaccord Genuity moved from $2.50 to $4.00, TD Cowen raised its target from $2 to $3, and B. Riley Securities - the most bullish of the group - hiked its target from $3 to $5 while maintaining a Buy rating. Not every analyst turned positive, though: BMO Capital kept a Sell rating even as it nudged its price target up slightly to $1.30, a reminder that opinion on the stock remains genuinely split.
...
- **A shift from hardware sales toward service revenue can signal improving business stability.** Similar to [Instacart's guidance raise alongside a surge in free cash flow](/en/news/instacart-cart-stock-surges-12-percent-q2-earnings-q3-guidance-raise/), recurring revenue and cash-flow metrics tend to carry more weight for sustainability than a one-time revenue surprise.
- **Even when several brokerages raise price targets sharply on the same day, it's worth checking whether any analyst still holds the opposite view.** Here, B. Riley set a Buy rating with a $5 target while BMO Capital kept a Sell rating with a $1.30 target on the very same earnings report - a reminder to look at the full spread of analyst opinion rather than anchoring on a single price target.
...
- [Plug Power Gains Momentum After Earnings As Analysts Raise Forecast - Yahoo Finance](https://finance.yahoo.com/news/plug-power-gains-momentum-earnings-171534021.html)
