...
title: "Elliott Wave Theory Trading: Reading Trend Position with 5-Wave Impulses and 3-Wave Corrections"
description: "Learn Elliott Wave Theory's 5-wave impulse, 3-wave correction, the three inviolable rules, and how to time entries around Wave 3."
order: 34
updated: 2026-08-25
...
1. Identify a clean, credible Wave 1 advance.
2. While Wave 2 unfolds, use the retracement levels covered in Lesson 30's [Fibonacci Retracement & Extension](/en/strategies/fibonacci-retracement-extension/) — typically 50%-61.8%, occasionally as deep as 78.6% — to estimate where it's likely to stall.
3. If Wave 2 holds above the Wave 1 start (respecting Rule 1) and prints a confirmation signal — a reversal candle, a volume pickup — that zone becomes the Wave 3 entry candidate.
4. Place the stop just below the Wave 1 starting point — the exact level where Rule 1 would be broken.
5. Use Fibonacci extensions for targets. Wave 3 conventionally often runs to roughly 1.618 times the length of Wave 1 — this is a frequently observed tendency, not a statistically validated law, and should be treated that way explicitly.
...
<figure class="diagram">
  <img src="/static/img/charts/en/elliott-wave-theory.svg" alt="Diagram of Elliott Wave Theory's five-wave impulse (1-2-3-4-5) and three-wave correction (A-B-C), showing that Wave 2 must stay above the Wave 1 start and Wave 4 must not overlap the Wave 1 price territory, with the Wave 3 entry point marked" loading="lazy">
  <figcaption>The full cycle: a five-wave impulse (1-2-3-4-5) followed by a three-wave correction (A-B-C), with the two inviolable rules — Wave 2 holding above the Wave 1 start, and Wave 4 not overlapping Wave 1's territory — and the Wave 3 entry point marked.</figcaption>
</figure>
