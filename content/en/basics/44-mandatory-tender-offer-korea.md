...
title: "What Is a Tender Offer — Why Korea Is Bringing Back Mandatory Tender Offers After 27 Years"
description: "Why the control premium in a takeover has historically gone only to the controlling shareholder, and how Korea's proposed mandatory tender offer rule would force acquirers to offer the same price to everyone else."
order: 44
updated: 2026-08-27
...
Tender offers aren't used for only one purpose. The best-known case is an acquirer trying to gain control of a company, sweeping up both the controlling stake and shares held by the public. But a controlling shareholder who already has control can also use a tender offer to buy out remaining minority holders as part of a [going-private delisting](/en/basics/spin-off-vs-carve-out/), and a company itself can run a tender offer as a form of [share buyback](/en/basics/stock-splits-and-buybacks/). This lesson focuses on the first case — a tender offer tied to a change in control.
