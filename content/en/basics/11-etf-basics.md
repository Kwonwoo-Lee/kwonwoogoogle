---
slug: etf-basics
title: "What Is an ETF? How It Differs from Individual Stocks and Index Funds"
description: "How an ETF bundles many holdings into one basket you can trade in real time on an exchange, and how it differs from individual stocks and index funds in cost and diversification."
order: 11
updated: 2026-08-11
...
Before buying an ETF, check three things: (1) exactly which index or asset it tracks, (2) its expense ratio (TER), and (3) whether it trades with enough volume (liquidity) to buy and sell without a wide bid-ask spread. If you already understand the [basics of diversification](/en/basics/risk-management-basics/), an ETF is simply the cheapest, easiest tool for putting that principle into practice.
