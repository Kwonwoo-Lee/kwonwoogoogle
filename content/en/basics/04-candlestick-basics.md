...
description: "What bullish and bearish candles mean, what the body and wicks tell you, and basic candlestick patterns like the doji and hammer — your first step in reading charts."
order: 4
updated: 2026-08-02
...
<figure class="diagram">
  <img src="/static/img/charts/en/candle-anatomy.svg" alt="Anatomy of a candle: open, high, low, close, body, and wick" loading="lazy">
  <figcaption>One candle = Open, High, Low, Close (OHLC) + body and wick</figcaption>
</figure>
...
<figure class="diagram">
  <img src="/static/img/charts/en/candle-patterns.svg" alt="Doji, Hammer, Inverted Hammer (Shooting Star), and long bullish candle patterns compared" loading="lazy">
  <figcaption>From left to right: Doji, Hammer, Inverted Hammer (Shooting Star), long bullish candle</figcaption>
</figure>
