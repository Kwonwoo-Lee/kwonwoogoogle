...
title: "Convertible Bonds Explained — Why a 0% Coupon Bond Can Still Attract Buyers"
description: "How convertible bonds bundle debt with a call option on shares, why the 'refixing' clause on the conversion price can weigh on a stock, and how CBs differ from warrant bonds and exchangeable bonds."
order: 40
updated: 2026-08-25
...
Companies generally have three broad ways to raise money: pure debt (bank loans, straight corporate bonds), pure equity (a [rights offering](/en/basics/rights-offering-and-bonus-issue/)), and hybrids like the CB that sit between the two. CBs offer a few concrete advantages over either pure option.
