...
title: "Nominal vs. Real Returns: How Inflation Quietly Eats Your Gains"
description: "Why an '8% annual return' might really only be 5%, how the Fisher equation separates nominal from real returns, and why money illusion makes this mistake so easy."
order: 20
updated: 2026-08-15
...
This isn't a brand-new idea if you've read [Why Invest? Compound Interest vs. Savings Accounts](/en/basics/why-invest-compound-interest/) — that comparison between bank deposit rates and long-run stock market returns was already implicitly leaning on real returns. If a deposit rate roughly matches inflation, your purchasing power is standing still even as the balance climbs. This lesson makes that math explicit.
...
- **Bonds**: a fixed-coupon bond is priced at issuance based on expected inflation, but if actual inflation runs hotter than that expectation, the bondholder's real return erodes accordingly. This connects to the discount-rate mechanism covered in [How Interest Rates Affect Stock Valuations](/en/basics/interest-rates-and-stock-valuations/).
...
Because different asset classes respond so differently, the diversification logic covered in [Correlation and Diversification](/en/basics/correlation-and-diversification/) picks up another dimension once you factor in the inflation regime. Which asset holds up best against inflation isn't a fixed property — it shifts with the rate and policy environment of the moment.
