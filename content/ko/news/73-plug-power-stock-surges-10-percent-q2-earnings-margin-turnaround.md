...
특히 현금소진액이 전분기 대비 58% 줄었다는 점은 재무 건전성 측면에서 더 중요한 의미를 지닙니다. 만성 적자 기업의 주가를 짓눌러온 가장 큰 리스크는 실적 부진 자체보다 '현금이 바닥나 또다시 지분을 희석하는 유상증자에 나설 수밖에 없다'는 두려움인 경우가 많습니다. 현금소진 속도가 빠르게 둔화되고 있다는 신호는 이 희석 리스크를 낮추는 방향으로 작용하며, 실제로 이번 실적 발표 이후 여러 증권사가 목표주가를 일제히 상향했습니다. 서스쿼해나는 2.75달러에서 3.75달러로, 캐나코드제뉴이티는 2.50달러에서 4달러로, TD코웬은 2달러에서 3달러로 목표주가를 높였고, 가장 공격적인 B.라일리증권은 3달러에서 5달러로 상향하며 매수 의견을 유지했습니다. 다만 BMO캐피털은 매도 의견을 유지하되 목표주가만 1.30달러로 소폭 올려, 여전히 신중한 시각도 공존하고 있음을 보여줬습니다.
...
- **여러 증권사가 동시에 목표주가를 큰 폭으로 올려도, 여전히 반대 의견(매도)을 유지하는 곳이 있다면 그 이유를 함께 확인할 필요가 있습니다.** 이번 사례처럼 B.라일리는 매수·목표가 5달러, BMO는 매도·목표가 1.30달러로 같은 실적을 두고도 극단적으로 엇갈린 해석이 나올 수 있으므로, 단일 애널리스트 의견에 의존하기보다 컨센서스 분포 자체를 살펴보는 습관이 중요합니다.
