...
지금까지는 캔들 하나로 판단하는 패턴을 봤습니다. 실전에서는 **연속된 두 캔들의 관계**를 보는 패턴도 자주 쓰입니다.

### 장악형 (Engulfing)
직전 캔들의 몸통을 다음 캔들의 몸통이 완전히 감싸는(장악하는) 패턴입니다. 하락 추세 끝에 작은 음봉 다음 그보다 훨씬 큰 양봉이 그 음봉의 몸통을 완전히 덮으면 **상승장악형**이라 부르고, 매수세가 매도세를 압도적으로 눌렀다는 신호로 해석합니다. 반대로 상승 추세 끝에 큰 음봉이 직전 양봉을 완전히 덮으면 **하락장악형**입니다.
