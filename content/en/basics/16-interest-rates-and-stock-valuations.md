...
title: "How Interest Rates Affect Stock Valuations: The Discount Rate Mechanism"
description: "Why central bank rate decisions move the entire stock market, how the discount rate mechanism reprices future earnings, and why growth stocks react harder to rate changes than value stocks."
order: 16
updated: 2026-08-13
...
On the day a central bank announces its rate decision, the entire market can swing sharply — even though no individual company's revenue, profits, or business model changed overnight. To understand why, it helps to go one level deeper than the "expectations" idea covered in [why stock prices move](/en/basics/why-stock-prices-move/). A stock's price isn't really about how much a company earns today — it behaves much more like **the present-day value of all the money that company is expected to earn in the future.** The tool markets use to convert those future dollars into a value for today is the interest rate — more precisely, the discount rate. Change the interest rate, and the underlying business hasn't moved at all, but the number the market treats as "fair value" shifts anyway.
