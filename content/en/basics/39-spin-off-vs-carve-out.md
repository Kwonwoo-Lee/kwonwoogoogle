...
title: "Spin-Off vs Carve-Out — What Happens to Your Shares When a Company Splits"
description: "Why a spin-off hands you shares in the new company while an equity carve-out leaves the parent holding all of them, and how that one difference drives dilution, parent-stock reactions, and Korea's 'split listing' controversy."
order: 39
updated: 2026-08-24
...
This is fundamentally different from a [stock split or buyback](/en/basics/stock-splits-and-buybacks/), which only changes how many slices the existing pie is cut into. A corporate split physically divides the company into two distinct legal entities with separate balance sheets, separate management, and eventually separate market valuations.
...
**The parent's valuation absorbs a discount.** Once the subsidiary trades publicly, any investor wanting exposure to that business can simply buy the subsidiary directly, with no reason to accept the parent as a middle layer. The market therefore tends not to give the parent full credit for the stake it still holds — the same logic that drives the [holding company discount](/en/basics/holding-company-discount/). This is why parent stocks so frequently fall hard the day a carve-out-and-list plan is announced.
